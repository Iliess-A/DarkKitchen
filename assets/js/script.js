const table=[
    ...
    ['assets/img/1063.jpg','nom','ingrediant','price','rating(sur 5)','filter'],
    ['assets/img/','nom','ingrediant','price','rating(sur 5)','filter'],
    ['assets/img/','nom','ingrediant','price','rating(sur 5)','filter'],
    ['iassets/img/','nom','ingrediant','price','rating(sur 5)','filter'],
    ['assets/img/','nom','ingrediant','price','rating(sur 5)','filter'],
    ['assets/img/','nom','ingrediant','price','rating(sur 5)','filter'],
    ['assets/img/','nom','ingrediant','price','rating(sur 5)','filter'],
    ['assets/img/','nom','ingrediant','price','rating(sur 5)','filter'],
